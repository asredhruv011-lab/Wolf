  ...
  return (
    ...
    <main> 
      <div className="images">
        <img id='tomorowland' src="public/tommorowland.png" alt="" />
        <img id='navy-pier'    src="public/navy-pier.png" alt="" />
        <img id='msi-chicago'  src="public/msi-chicago.png" alt="" />
        <img id='phone'        src="public/phone.png" alt="" />
        <img id='kikk'         src="public/kikk.png" alt="" />
        <img id='kennedy'      src="public/kennedy.png" alt="" />
        <img id='opera'        src="public/opera.png" alt="" />
      </div>
      <Canvas 
      id='canvas-elem' 
     style={{
       ...
       <section id='section-2'>
        <div className="titles">
          ...
          <div img-title='tomorowland' className="title">
          ...
          <div img-title='phone' className="title">
            <small>2020 - ONGOING</small>
            <h1> This Was Louises's Phone </h1>
          </div>
       ...
       <section id='section-4'>
        <div className="bottom">
          <div className="left"></div>
          <div className="right">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda fuga eius debitis odit ab harum. Perspiciatis magni, quia quidem magnam itaque vel aspernatur amet perferendis quam porro inventore. Exercitationem consequatur veniam eius assumenda cumque beatae vel optio quos porro doloribus?</p>
